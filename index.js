      ...
      <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        @media (max-width: 768px) {
          ...
          h1 { font-size: 2em; }
          .config-box { font-size: 10px; padding: 15px; }
        }
      </style>
    </head>
    <body>
      <div class="container">
        ...
        <div class="proxy-info">
          ...
          <p><strong>Backend:</strong> ${proxyIPWithPort}</p>
        ...
        <div class="grid">
          <div class="card">
            ...
            <div class="config-box">${dreamConfig}</div>
            <button class="copy-btn" onclick="copyToClipboard('${dreamConfig}')">Copy</button>
          </div>

          <div class="card">
            <h3>🎪 Sing-box Configuration</h3>
            <div class="config-box">${freedomConfig}</div>
            <button class="copy-btn" onclick="copyToClipboard('${freedomConfig}')">Copy</button>
          </div>
        </div>

        <div class="info-box">
          <h3>📋 Subscription Links</h3>
          <p><strong>Standard Sub:</strong> <a href="https://${hostName}/sub/${userID}" class="button">Get Subscription</a></p>
          <p><strong>IP Sub:</strong> <a href="https://${hostName}/ipsub/${userID}" class="button">Get IP Subscription</a></p>
          <p><strong>Clash Meta:</strong> <a href="${clashMetaFullUrl}" class="button">Import to Clash</a></p>
        </div>
      </div>
 ...
 * @param {Uint8Array|null} protocolResponseHeader - Optional protocol response header.
 */
